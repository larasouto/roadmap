...
describe('Course e2e test', () => {
  ...
  const courseSample = { name: 'for even', department: 'kissingly' };
  ...
  describe('new Course page', () => {
    ...
    it('should create an instance of Course', () => {
      cy.get(`[data-cy="name"]`).type('shocked at');
      cy.get(`[data-cy="name"]`).should('have.value', 'shocked at');

      cy.get(`[data-cy="department"]`).type('usefully outlaw optimal');
      cy.get(`[data-cy="department"]`).should('have.value', 'usefully outlaw optimal');
