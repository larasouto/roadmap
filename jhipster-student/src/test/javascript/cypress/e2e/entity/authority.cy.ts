...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'c90d5c7f-fc5f-489b-ade2-2d91ac2b74c9' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('e3c522a0-8d1d-42eb-9132-3c61481f4546');
      cy.get(`[data-cy="name"]`).should('have.value', 'e3c522a0-8d1d-42eb-9132-3c61481f4546');
