...
describe('Student e2e test', () => {
  ...
  const studentSample = { firstName: 'Rhett', lastName: 'Sipes', email: 'Savannah_Halvorson@gmail.com', age: 18110 };
  ...
  describe('new Student page', () => {
    ...
    it('should create an instance of Student', () => {
      cy.get(`[data-cy="firstName"]`).type('Idella');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Idella');

      cy.get(`[data-cy="lastName"]`).type('Toy');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Toy');

      cy.get(`[data-cy="email"]`).type('Hope_Gleichner10@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Hope_Gleichner10@hotmail.com');

      cy.get(`[data-cy="age"]`).type('7471');
      cy.get(`[data-cy="age"]`).should('have.value', '7471');
