...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 29468 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 13515 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 30559 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 20821 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 29822 };
      post.blog = blog;
      const tag: ITag = { id: 27280 };
      post.tags = [tag];
